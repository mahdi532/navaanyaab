...
// 🔑 تنظیمات تلگرام (از متغیرهای محیطی می‌خواند)
...
async function sendTelegram(message) {
    if (!TELEGRAM_BOT_TOKEN || !TELEGRAM_CHAT_ID) {
        // این هشدار فقط در صورتی که توکن در هیچ محیطی ست نشده باشد نشان داده می‌شود
        // در Koyeb این شرط همیشه درست است
...
>>>>>>> f69e80a47568922a0cbc5d8cc8042584568ac778
=======
require('dotenv').config();
...
>>>>>>> 16c537459d4b87767fef5f80b550da8b2583ae7d
